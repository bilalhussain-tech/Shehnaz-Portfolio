...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: 'Skincare',
    price: 55,
    image: 'https://images.unsplash.com/photo-1601055283742-ce346f634542?q=80&w=600&auto=format&fit=crop',
    description: 'A lightweight facial oil that mimics the skin\'s natural lipids.',
    rating: 4.9,
    reviewsCount: 420,
    concern: ['Radiance', 'Glow'],
    skinType: ['All Skin Types'],
    ingredients: ['Jojoba Oil', 'Rosehip Seed Oil', 'Vitamin C'],
  },
  {
    id: '7',
    name: 'Divine Lash Mascara',
    brand: 'Shehnaz Makeup',
    category: 'Makeup',
    price: 28,
    image: 'https://images.unsplash.com/photo-1591360236630-4ed9bc3d67f2?q=80&w=600&auto=format&fit=crop',
    description: 'Ultra-black formula for infinite length and volume.',
    rating: 4.7,
    reviewsCount: 1540,
    concern: ['Volume', 'No-smudge'],
    ingredients: ['Castor Oil', 'Beeswax', 'Iron Oxides'],
  },
  {
    id: '8',
    name: 'Midnight Oud',
    ...
    description: 'Deep, mysterious, and intoxicating wood notes.',
    rating: 4.8,
    reviewsCount: 120,
    concern: ['Bold'],
